...
def ParseConfig(xmlfilename):
	...
	BatchDB.host=root_node.findtext('ancil_db_host')
	BatchDB.batchUser=root_node.findtext('ancil_user')
        BatchDB.batchPass=root_node.findtext('ancil_passwd')
        BatchDB.dbexpt=root_node.findtext('ancil_db_name')
	BatchDB.dbboinc=root_node.findtext('ancil_boinc_db_name')
...
def plot_batch_stats(out_path,batch_prefix):
	...
	fig.savefig(out_path+"oifs_batch_statistics_main.png")
